"""
A spaceship has exploded in the space and two survivors need to communicate with the station in the earth. Due to voice communication failure, they can hear only beep sound. 
Each consecutive beep sound denotes an alphabet. For example, two consecutive beep sound means the alphabet b. The beep sounds are represented as 1's. Group of consecutive 1's
are given as input in each line. Help the crew to decode the message.
